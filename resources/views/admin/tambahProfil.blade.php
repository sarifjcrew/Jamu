...
<div class="wrapper">
  ...
  <div class="row mb-3">
    <label for="colFormLabel" style="position: center;" class="col-sm-2 col-form-label">Deskripsi</label>
    <div class="col-sm-7">
      <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>  
    </div>
  </div>
  <button type="button" class="btn btn-primary">Tambah Profile</button>
</div>
    <!-- /.content -->
  </div>
  <!-- /.content-wrapper -->
...
<script>
    const tombol = document.querySelector('.btn-primary');
        tombol.addEventListener('click', function () {
            swal("Profile Berhasil DiTambah", "", "success");
        });
</script>
</body>
</html>
