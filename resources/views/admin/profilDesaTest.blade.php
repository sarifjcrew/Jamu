...
<head>
  ...
  <link rel="stylesheet" href="{{asset('https://cdnjs.cloudflare.com/ajax/libs/tempusdominus-bootstrap-4/5.39.0/js/tempusdominus-bootstrap-4.min.js')}}">
  <!-- iCheck -->
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="{{asset('https://cdn.jsdelivr.net/npm/summernote@0.8.11/dist/summernote-bs4.min.css')}}">
</head>
...
<div class="wrapper">
  ...
  <!-- <nav class="main-header navbar navbar-expand navbar-white navbar-light"> -->
    ...
    <!-- <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{route('profil-desa')}}" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="{{route('profil-desa')}}" class="brand-link">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('profil-desa')}}" class="nav-link">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('profil-desa')}}">Home</a></li>
...
<!-- Sparkline -->
<script src="{{asset('https://cdnjs.cloudflare.com/ajax/libs/jquery-sparklines/2.1.2/jquery.sparkline.min.js')}}"></script>
<!-- JQVMap -->
...
<!-- Tempusdominus Bootstrap 4 -->
<script src="{{asset('https://cdnjs.cloudflare.com/ajax/libs/tempusdominus-bootstrap-4/5.39.0/js/tempusdominus-bootstrap-4.min.js')}}"></script>
<!-- Summernote -->
<script src="{{asset('https://cdn.jsdelivr.net/npm/summernote@0.8.11/dist/summernote-bs4.min.css')}}"></script>
<!-- overlayScrollbars -->
