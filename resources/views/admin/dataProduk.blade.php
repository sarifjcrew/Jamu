        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <button type="button" onclick="window.location.href='{{route('tambah-produk')}}'" class="btn btn-primary">Tambah Produk</button>
                <br>
                <br>
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td>X</td>
                    <td>
                      <button type="button" onclick="window.location.href='{{route('ubah-produk')}}'" class="btn btn-primary">Ubah</button>
                      <br><br>
